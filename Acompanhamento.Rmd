...
p_1 <- p %>% ggplotly() %>% layout(title=list(text=paste("<b>Evolução após 1º caso</b>"),
                                   ...
                                   list(x = 0.8, 
                                        y = -0.05,
                                        text = paste0("Fonte:ECDC.", paste("Atualizado:",format(Sys.time(), "%d/%m/%Y"))), 
                                        showarrow = F,
                                        xref='paper',
                                        yref='paper', 
                                        xanchor='left', 
