...
confirmed_cases_city <- ggplot(
  data,
  aes(x = date, y=confirmed, group = city,colour = factor(city), text = paste0("Cidade: ", city,"<br>","Casos Confirmados Acumulados: ", confirmed, "<br>", "Data: ", date))
  ) +
  geom_line()+
  scale_color_viridis_d() +
  labs(title = paste("Número de casos de COVID-19 por cidade catarinense - ",format(Sys.time(), "%d/%m/%Y"))) + xlab("Data") + ylab("Casos confirmados")+ theme_minimal() +
