...
p <- dados_selecionados %>%  ggplot(aes(x=days_from_first, y=sum_cases, color=labels, linetype=labels,label=labels,
             text = paste0("País: ", labels,"<br>",
                           "Casos Confirmados: ", sum_cases, "<br>",
                           "Óbitos Confirmados:", sum_deaths, "<br>",
                           "Dias desde o 1º caso: ",days_from_first))) + 
  geom_line(size=1) + 
...
p <- dados_selecionados %>% 
  ggplot(aes(x=days_from_100th, y=sum_cases, color=labels, linetype=labels,label=labels,
             text = paste0("Local: ", labels,"<br>",
                           "Casos Confirmados: ", sum_cases, "<br>",
                           "Óbitos Confirmados:", sum_deaths, "<br>",
                           "Dias desde o 100º caso: ",days_from_100th))) + geom_line()+ 
...
p<- dados_selecionados_estat %>% 
  ggplot(aes(x=days_from_100th, y=cases_per_1000, color=labels, linetype=labels, label=labels,
             text = paste0("Local: ", labels,"<br>",
                           "Casos por 100 habitantes: ", cases_per_1000, "<br>",
                           "Dias desde o 100º caso: ",days_from_100th))) + geom_line()+ 
...
p_lin <- casos_por_estado %>% 
  ...
  ggplot(aes(x=days_from_10th, y=totalCases, color=state,linetype=state,label=state,
             text = paste0("Local: ", state,"<br>",
                           "Casos Confirmados: ", totalCases, "<br>",
                           "Dias desde o 10º caso: ",days_from_10th))) + geom_line(size=1)+ 
...
p_lin_1000 <- casos_por_estado %>% 
  ...
  ggplot(aes(x=days_from_10th, y=total_cases_pop, color=state,label=state,
             text = paste0("Local: ", state,"<br>",
                           "Casos Confirmados: ", totalCases, "<br>",
                           "Dias desde o 10º caso: ",days_from_10th))) + geom_line()+ 
